...
Native Android art-book exercise with basic screen, form, and image workflows.

## Overview

Native Android art-book exercise with basic screen, form, and image workflows. The description and capabilities in this document are limited to behavior that can be verified in the repository source.
